        ...
        <div class="container">
            ...
            <div id="navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/discuss/getAllDiscuss.a">讨论</a></li>
                    <li><a href="#contact">问吧</a></li>
                    <li><a href="/student-community/getAllDynamics.a">动态</a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li style="height:60px"><a href="#"><img src="/student-community/face/1.jpg" width="30px">&nbsp;紫萱</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
