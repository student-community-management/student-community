...
<body>
	...
	<div class="container" style="margin-top:50px;">
		...
		<input id="activityContent"  value="${activity.activityContent}" name="activityContent" type="hidden"/>
			<table width="100%" cellpadding="0" cellspacing="0" class = "myfont" border="1">
				...
				<td style="width:25%" align="center">社团名称</td>
					...
					<td>
						<input type ="text" id="title" name="activityTitle" value="${activity.activityTitle}" class="form-control" style="width:250px;"/>
					</td>
					</tr>
					<tr>
